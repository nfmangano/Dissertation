...
Table \ref{chapter:evaluation:designbehaviors-table} summarizes the features that supported each design behavior, which included scraps, palette, intentional interfaces, and fading highlighter. Instances in which the groups performed the design behavior, but without the support of Calico's advanced features, are marked as ``without feature''. This occurred, for example, if they performed a design behavior using regularly sketching as they would have on a regular whiteboard, or if they used an external artifact, such as their own computer. 
...
\endlastfoot
\hline
\multirow{5}{5cm}{1. They draw different kinds of diagrams}&Scraps &X &X &X  \\*\cline{2-5}
&Palette & & &  \\*\cline{2-5}
&Intentional Interfaces & & &  \\*\cline{2-5}
&Fading highlighter & & &  \\\cline{2-5}
&Without feature &X &X &X  \\\cline{1-5}
\multirow{5}{5cm}{2. They produce sketches that draw what they need, and no more}&Scraps &X &X &X  \\*\cline{2-5}
&Palette &X &X &  \\*\cline{2-5}
&Intentional Interfaces & & &  \\*\cline{2-5}
&Fading highlighter &X &X &X \\\cline{1-5}
&Without feature &X &X &X  \\\cline{1-5}
\multirow{5}{5cm}{3. They refine and evolve their sketches over time}&Scraps &X & &  \\*\cline{2-5}
&Palette & & &  \\*\cline{2-5}
&Intentional Interfaces & & &  \\*\cline{2-5}
&Fading highlighter & & & \\\cline{2-5}
&Without feature & &X &  \\\cline{1-5}
\multirow{5}{5cm}{4. They use impromptu notations}&Scraps & &X &X  \\*\cline{2-5}
&Palette & &X &  \\*\cline{2-5}
&Intentional Interfaces & & &  \\*\cline{2-5}
&Fading highlighter & & & \\\cline{2-5}
&Without feature &X &X &  \\\cline{1-5}
\multirow{5}{5cm}{5. They move from one perspective to another}&Scraps & & &  \\*\cline{2-5}
&Palette & & &  \\*\cline{2-5}
&Intentional Interfaces &X &X &X  \\*\cline{2-5}
&Fading highlighter & & & \\\cline{2-5}
&Without feature &X &X &X  \\\cline{1-5}
\multirow{5}{5cm}{6. They move from one alternative to another}&Scraps & & &  \\*
\cline{2-5}
&Palette & & &  \\*
\cline{2-5}
...
&Fading highlighter & & & \\\cline{2-5}
&Without feature &X &X &X  \\\cline{1-5}
\multirow{5}{5cm}{7. They move from one level of abstraction to another}&Scraps &X & &  \\*
\cline{2-5}
&Palette & & &  \\*
\cline{2-5}
&Intentional Interfaces &X & &X  \\*
\cline{2-5}
&Fading highlighter & & & \\\cline{2-5}
&Without feature & & &  \\\cline{1-5}
\multirow{5}{5cm}{8. They perform mental simulations}&Scraps & & &  \\*
\cline{2-5}
&Palette & & &  \\*
\cline{2-5}
&Intentional Interfaces & & &  \\*
\cline{2-5}
&Fading highlighter &X & &X \\\cline{2-5}
&Without feature &X &X &X  \\\cline{1-5}
\multirow{5}{5cm}{9. They juxtapose sketches}&Scraps &X & &X  \\*
\cline{2-5}
&Palette & & &X  \\*
\cline{2-5}
&Intentional Interfaces & & &  \\*
...
&Fading highlighter & & & \\\cline{2-5}
&Without feature &X &X &X  \\\cline{1-5}
\multirow{5}{5cm}{10. They review their progress}&Scraps & & &  \\*
\cline{2-5}
&Palette & & &  \\*
\cline{2-5}
...
&Fading highlighter & & & \\\cline{2-5}
&Without feature & & &  \\\cline{1-5}
\multirow{5}{5cm}{11. They retreat to previous ideas}&Scraps & & &  \\*
\cline{2-5}
&Palette & & &  \\*
\cline{2-5}
&Intentional Interfaces &X & &X  \\*
...
&Fading highlighter & & & \\\cline{2-5}
&Without feature & & &  \\\cline{1-5}
\multirow{5}{5cm}{12. They switch between synchronous and asynchronous work}&Scraps & & &  \\*
\cline{2-5}
&Palette & & &  \\*
\cline{2-5}
&Intentional Interfaces &X & &X  \\*
...
&Fading highlighter & & & \\\cline{2-5}
&Without feature & & &  \\\cline{1-5}
\multirow{5}{5cm}{13. They explain their sketches to each other}&Scraps & & &  \\*
\cline{2-5}
&Palette & & &  \\*
\cline{2-5}
&Intentional Interfaces & & &  \\*
...
&Fading highlighter &X & &X \\\cline{2-5}
&Without feature & & &  \\\cline{1-5}
\multirow{5}{5cm}{14. They bring their work together}&Scraps & & &  \\*\cline{2-5}
&Palette & & &  \\*\cline{2-5}
&Intentional Interfaces &X & &  \\*\cline{2-5}
&Fading highlighter & & &\\*\cline{2-5}
&Without feature & & & 
