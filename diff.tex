...
\textbf{Fading highlighter.} The interaction \DIFdelbegin \DIFdel{designers }\DIFdelend \DIFaddbegin \DIFadd{design group }\DIFaddend reported positive feedback about this feature, however, they \DIFdelbegin \DIFdel{seldomly }\DIFdelend \DIFaddbegin \DIFadd{seldom }\DIFaddend used it in practice. They reported the feature would be highly useful in working with larger groups, but all of their sessions took place with at most two \DIFdelbegin \DIFdel{interaction designers}\DIFdelend \DIFaddbegin \DIFadd{people}\DIFaddend . Further, they found the name confusing as it did not function as they expected a regular highlighter would, in which a marker changes the color behind written text. Instead, they colloquially referred to it as the ``John Madden mode'', in reference to the sports announcer.
...
\textbf{Fading highlighter.} The members made light use of \DIFaddbegin \DIFadd{the }\DIFaddend fading highlighter. They reported that, while it was useful on occasion, they preferred to talk out loud and make pointing gestures using their hands. In remote sessions, the \DIFdelbegin \DIFdel{research }\DIFdelend \DIFaddbegin \DIFadd{group member }\DIFaddend from CMU relied on video communication to see these non-verbal cues. \DIFdelbegin \DIFdel{They found it helpful, but }\DIFdelend \DIFaddbegin \DIFadd{Though they found the fading highlighter helpful, they }\DIFaddend often times forgot that it was available. \DIFdelbegin \DIFdel{Reported }\DIFdelend \DIFaddbegin \DIFadd{They reported }\DIFaddend that they would have used it more if it had been easier to invoke.
